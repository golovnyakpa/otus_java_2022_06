...
public class HomeWork {
    ...
    public static void main(String[] args) {
        ...
        EntitySQLMetaDataImpl<Manager> entitySQLMetaDataManager = new EntitySQLMetaDataImpl<>(entityClassMetaDataManager);
        DataTemplateJdbc<Manager> dataTemplateManager = new DataTemplateJdbc<>(
                dbExecutor,
